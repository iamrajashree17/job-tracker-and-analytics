...
export async function listJobs(userId: string, status?: string, fromDate?: string, toDate?: string) {
...
export async function updateJob(jobId: string, userId: string, updates: {
  company?: string;
  role?: string;
  status?: string;
  appliedAt?: string;
